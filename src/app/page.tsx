...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="z-[50] sticky top-0 w-full bg-background/100  backdrop-blur-sm dark:bg-black/[0.6] border-border/40">
        <div className="container h-14 flex items-center px-4">
          ...
          >
            ...
            <span className="font-bold">Tikiti-Ke</span>
            <span className="sr-only">Tikiti-Ke</span>
          </Link>
      ...
      <main className="min-h-[calc(100vh-57px-97px)] flex-1">
        <div className="container relative pt-10 pb-10">
